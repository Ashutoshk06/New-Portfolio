    ...
    <div className ="grid md:grid-cols-2 place-items-center">
        ...
        <div>
            <div className ="text-gray-300 my-3">
                ...
                <p className="text-justify leading-7 w-11/12 ">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Inventore natus recusandae tenetur, ex consequuntur reiciendis fuga quisquam qui magni ratione, amet ducimus, repellendus enim. Adipisci iste ratione atque cum quis.</p>
            </div>
            ...
            <div className="flex mt-10 items-center gap-7">
                    ...
                    <div className="bg-gray-800/40 p-5 rounded-lg">
                        <h3 className="md:text-4xl text-2xl font-semibold text-white">8.7
                           <span className =""></span>
                        </h3>
